...
#define alloca(size) ((void*) _alloca(size))
...
#undef HAVE_RENAME
//	#define	HAVE_RENAME	//	undef since Win32 rename is different from Unix
						//	in that the files must both be closed!
...
/* Define the handles on standard file streams */
